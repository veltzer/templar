...
distutils.core.setup(
	...
	package_dir={'templar/wrappers': 'src/templar/wrappers', 'templar': 'src/templar'},
	...
	data_files=[
		...
		('/usr/share/templar/templates', ['templates/control.mako', 'templates/files.mako', 'templates/README.md.mako', 'templates/copyright.mako', 'templates/changelog.mako', 'templates/rules.mako']),
		('/usr/bin', ['src/templar_cmd', 'src/make_helper']),
	],
)
