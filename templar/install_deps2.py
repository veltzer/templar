...
def install_jsmin():
    ...
    if not os.path.isdir(tools):
        os.mkdir(tools)
    os.system('wget -qO- https://raw.githubusercontent.com/douglascrockford/JSMin/master/jsmin.c |'
