...
def run(d, source=True, gbp=False):
    ...
    templar.api.process(d, templar.utils.pkg_get_real_filename(__file__, 'templates/changelog.mako'),
                        'debian/changelog')
    ...
    templar.api.process(d, templar.utils.pkg_get_real_filename(__file__, 'templates/copyright.mako'),
                        'debian/copyright')
    # templar.api.process(d, templar.utils.pkg_get_real_filename(__file__, 'templates/files.mako'),
    #                   'debian/files')
    templar.api.process(d, templar.utils.pkg_get_real_filename(__file__, 'templates/format.mako'),
    ...
    templar.api.process(d, templar.utils.pkg_get_real_filename(__file__, 'templates/lintian-overrides.mako'),
